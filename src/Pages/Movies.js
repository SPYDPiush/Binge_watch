  ...
  const fetchData = async () => {
    const options = {
      ...
      headers: {
        ...
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0MTkxZjhmZWE2ZTU0NzNhY2UxZjM5OGIyYzE3ZTE3MiIsInN1YiI6IjY0MjQ0M2RlOTYwY2RlMDEwM2EzMzc4NSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.sxZYrzFLdzRD9qtQIuwcT1z_Eyblvr9_4X_S0EfJSiQ',
      },
    };

    try {
      const response = await fetch(`https://api.themoviedb.org/3/discover/movie?include_adult=true&include_video=true&language=en-US&page=${Page}&sort_by=revenue.desc`, options)
